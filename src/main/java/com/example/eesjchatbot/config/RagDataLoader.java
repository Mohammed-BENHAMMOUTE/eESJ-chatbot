package com.example.eesjchatbot.config;
...
public class RagDataLoader {
    @Value("classpath:/pdfs/fichier.pdf")
    private Resource pdfResseource;
...
//        if (!file.exists()) {
//            PagePdfDocumentReader pdfDocumentReader = new PagePdfDocumentReader(pdfResseource);
